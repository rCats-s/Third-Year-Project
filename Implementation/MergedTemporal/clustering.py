"""
BotDCGC – Section 4.3: Self-Optimising Clustering

Implements:
  • Student-t soft assignment  q_iu  (Eq. 18)
  • Target distribution        p_iu  (Eq. 19)
  • Clustering loss  KL(P||Q)        (Eq. 20)
  • Final label inference            (Eq. 22)
  • ClusteringModule wrapper         initialises centres with K-means
"""
...
# ---------------------------------------------------------------------------
# 4.3  Soft assignment via Student-t distribution  (Eq. 18)
# ---------------------------------------------------------------------------
...
def soft_assignment(z: torch.Tensor,
    ...
    Args:
        ...
        centers : (K, D)  cluster centre embeddings
    Returns:
        Q       : (N, K)  soft assignment probabilities
    """
