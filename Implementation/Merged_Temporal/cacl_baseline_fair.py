...
DATA_PATH    = r"D:\3rd year project\Implementation\Datasets\twibot22_out2\graph_data_model_ready_real.pt"
X_SHARED_PATH = r"D:\3rd year project\Implementation\runs\botdcgc_snowball_10k\x_shared.pt"
RUN_DIR      = r"D:\3rd year project\Implementation\runs\cacl_baseline_fair"
...
def main():
    ...
    model_path = os.path.join(RUN_DIR, "cacl_baseline_model.pt")
    torch.save({
    ...
    save_common_outputs(
        run_dir=RUN_DIR,
        model_name="cacl_baseline_fixed_xshared",
        user_ids=user_ids,
        labels=labels,
        split=split,
